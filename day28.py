...
import re
teja="This meta character will form a searching pattern as it will take any zero or more character"
om=re.findall("c.*i",teja)
mo=re.search("T.*",teja)
print(om)
print(mo)
...
6.+
---
-->This metacharacter  will form a searching pattern as it will take any one or more character for (+)
